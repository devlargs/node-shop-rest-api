...
exports.ordersGetAll = async (req, res, next) => {
    try {
...
exports.ordersCreateOrder = async (req, res, next) => {
    try {
...
exports.ordersGetOrder = async (req, res, next) => {
    try {
...
exports.ordersDeleteOrder = async (req, res, next) => {
    try {
